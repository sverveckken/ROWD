"use strict";
var w,h,sum,ctx,opts,difX,difY,rad,cos,sin,hexs,tick;
if(window.innerWidth > 1024) {
		w = dotty.width = window.innerWidth/2;
	}
    else {
    ...
    opts = {
      ...
      colors: [ 'rgba(194,159,117,alp)', 'rgba(250,89,89,alp)', 'rgba(231,194,74,alp)' ],
